...
/**
 * Classe responsável pela leitura de imagens em Base64 e arquivos ZIP no
...
public final class ImageReaderBase64 {
     ...
     * Construtor
     *
     * @param image Referência ao arquivo de imagem (ex. /icons/print.gif).
     * Estes arquivos devem estar zipados e associados ao classpath da
     * aplicação.
     */
