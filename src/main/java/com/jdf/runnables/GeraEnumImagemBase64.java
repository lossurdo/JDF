...
final class GeraEnumImagemBase64 {
	...
	public static void main(String[] args) throws Exception {
		File f = new File("D:/eclipseprojects/usdrsp/WebContent/mod_rsp/img");
		File[] arqs = f.listFiles();
		for (File file : arqs) {
			sb.append(stripName(file.getName()) + "(\"");
			sb.append(Image2Base64.toString(new File("D:/eclipseprojects/usdrsp/WebContent/mod_rsp/img/"+file.getName())));
		}
		...
		FileOutputStream fos = new FileOutputStream("d:\\temp\\IconPackBase64.java");
